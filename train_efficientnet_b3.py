...
Defaults: image_size=300, batch_size=4 (adjust if OOM).
Usage example:
  python train_efficientnet_b3.py --data_dir "C:\Varun\skin-detect-mvp\data" --epochs 12 --batch_size 4 --image_size 300
"""
...
def build_model(num_classes, model_name='efficientnet_b3', pretrained=True):
